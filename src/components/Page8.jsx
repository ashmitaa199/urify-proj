...
export default function Page8(){
    return(
        ...
        <section  class=" flex py-3 px-0 mt-16 md:flex md:py-8  md:mt-32">
          ...
          <section class="bg-black w-full h-[350px] absolute left-16 justify-self-center z-50 md:bg-black md:w-4/5 md:h-4/5 md:absolute md:left-44 md:justify-self-center  md:z-50">
            ...
            <button class="bg-white rounded w-22 h-6 absolute top-44 left-10 md:bg-white md:rounded md:w-44 md:h-12 md:absolute md:mt-32 md:left-20 md:font-semibold"> 
